...
export type OfferLmpm = {
  __typename?: 'OfferLmpm';
  price: Price;
};
...
export type OfferLmpmResolvers<ContextType = Context, ParentType extends ResolversParentTypes['OfferLmpm'] = ResolversParentTypes['OfferLmpm']> = ResolversObject<{
...
export type Resolvers<ContextType = Context> = ResolversObject<{
  ...
  OfferLmpm?: OfferLmpmResolvers<ContextType>;
